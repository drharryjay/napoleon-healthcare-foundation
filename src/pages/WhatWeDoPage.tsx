...
const servicePhotos: Record<string, SlidePhoto[]> = {
  "General Medical Consultations": [
    ...
    { src: "/images/outreach/sapele-e04.webp", alt: "Consultations in progress at the Ejemuojavwe women's health outreach" },
  ...
  "Dental Care": [
    { src: "/images/outreach/06-sapele-dental-care-website.webp", alt: "Dental care provided during the Ejemuojavwe women's health outreach" },
    { src: "/images/FB_IMG_1783012545155.jpg", alt: "NHF dental team providing dental care during a community outreach" },
  ],
  "Laboratory Screening": [
    { src: "/images/outreach/05-sapele-clinical-screening-website.webp", alt: "Clinical and laboratory screening during the Ejemuojavwe women's health outreach" },
    { src: "/images/outreach/14-sapele-finger-prick-screening-website.webp", alt: "Laboratory finger-prick screening during the Ejemuojavwe women's health outreach" },
    { src: "/images/outreach/15-sapele-blood-pressure-screening-website.webp", alt: "Blood-pressure screening during the Ejemuojavwe women's health outreach" },
  ],
  "Maternal and Child Health": [
    { src: "/images/outreach/07-sapele-health-counselling-website.webp", alt: "Health counselling during the Ejemuojavwe women's health outreach" },
  ...
  "Health Education": [
    { src: "/images/outreach/16-sapele-health-education-speaker-website.webp", alt: "A community health education talk during the Ejemuojavwe women's health outreach" },
